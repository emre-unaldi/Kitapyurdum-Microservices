...
import patika.customerservice.utils.client.OrderServiceClient;
...
public class OrderService {
    ...
    public List<OrderResponse> filterByCustomerId(Integer customerId) {
        try {
            ResponseEntity<GenericResponse<List<OrderResponse>>> response = orderServiceClient.filterByCustomerId(customerId);
