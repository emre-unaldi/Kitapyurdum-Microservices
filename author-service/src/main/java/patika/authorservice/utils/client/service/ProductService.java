package patika.authorservice.utils.client.service;
...
import patika.authorservice.utils.client.ProductServiceClient;
...
public class ProductService {
    ...
    public List<BookResponse> filterByBookAuthorId(Integer authorId) {
        try {
            ResponseEntity<GenericResponse<List<BookResponse>>> response = productServiceClient.filterByBookAuthorId(authorId);
    ...
    public List<MagazineResponse> filterByMagazineAuthorId(Integer authorId) {
        try {
            ResponseEntity<GenericResponse<List<MagazineResponse>>> response = productServiceClient.filterByMagazineAuthorId(authorId);
